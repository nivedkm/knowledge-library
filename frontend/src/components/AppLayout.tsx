  ...
  return (
    <div className="min-h-screen">
      <header className="relative flex w-full max-w-site items-center justify-center mx-auto py-5 border-b border-line">
        <div className="flex justify-center items-center gap-3 text-ink font-serif text-xl font-bold no-underline focus-ring" to="/" aria-label="Personal Knowledge Library home">
